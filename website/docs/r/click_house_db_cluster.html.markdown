...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_click_house_db_cluster&spm=docs.r.click_house_db_cluster.example&intl_lang=EN_US)
