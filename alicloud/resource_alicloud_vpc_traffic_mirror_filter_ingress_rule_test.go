...
func TestAccAliCloudVPCTrafficMirrorFilterIngressRule_basic2(t *testing.T) {
	var v map[string]interface{}
	checkoutSupportedRegions(t, true, connectivity.VpcTrafficMirrorSupportRegions)
	resourceId := "alicloud_vpc_traffic_mirror_filter_ingress_rule.default"
	ra := resourceAttrInit(resourceId, AlicloudVPCTrafficMirrorFilterIngressRuleMap0)
...
func TestUnitAlicloudVPCTrafficMirrorFilterIngressRule(t *testing.T) {
			...
			map[string]interface{}{
				"IngressRules": []interface{}{
					map[string]interface{}{
						...
						"InstanceId":                    "alicloud_vpc_traffic_mirror_filter_ingress_rule",
						...
						"TrafficMirrorFilterRuleId":     "alicloud_vpc_traffic_mirror_filter_ingress_rule",
					},
				},
			},
		},
	...
	t.Run("CreateClientAbnormal", func(t *testing.T) {
		...
		err := resourceAliCloudVpcTrafficMirrorFilterIngressRuleCreate(d, rawClient)
		patches.Reset()
		assert.NotNil(t, err)
	})
	...
	t.Run("CreateNormal", func(t *testing.T) {
		...
		err := resourceAliCloudVpcTrafficMirrorFilterIngressRuleCreate(dCreate, rawClient)
		patches.Reset()
		assert.Nil(t, err)
	})
	...
	t.Run("UpdateClientAbnormal", func(t *testing.T) {
		...
		err := resourceAliCloudVpcTrafficMirrorFilterIngressRuleUpdate(d, rawClient)
		patches.Reset()
		assert.NotNil(t, err)
	})
	...
	t.Run("UpdateTrafficMirrorFilterRuleAttributeAbnormal", func(t *testing.T) {
		...
		for _, key := range []string{"destination_cidr_block", "destination_port_range", "priority", "protocol", "source_cidr_block", "source_port_range", "rule_action", "dry_run"} {
			switch p["alicloud_vpc_traffic_mirror_filter_ingress_rule"].Schema[key].Type {
		...
		resourceData1, _ := schema.InternalMap(p["alicloud_vpc_traffic_mirror_filter_ingress_rule"].Schema).Data(nil, diff)
		...
		err := resourceAliCloudVpcTrafficMirrorFilterIngressRuleUpdate(resourceData1, rawClient)
		patches.Reset()
		assert.NotNil(t, err)
	})

	t.Run("UpdateMockParseResourceId", func(t *testing.T) {
		resourceData1, _ := schema.InternalMap(p["alicloud_vpc_traffic_mirror_filter_ingress_rule"].Schema).Data(nil, nil)
	...
	t.Run("DeleteClientAbnormal", func(t *testing.T) {
		...
		err := resourceAliCloudVpcTrafficMirrorFilterIngressRuleDelete(d, rawClient)
		patches.Reset()
		assert.NotNil(t, err)
	})
	...
	t.Run("DeleteMockParseResourceId", func(t *testing.T) {
		...
		err := resourceAliCloudVpcTrafficMirrorFilterIngressRuleDelete(resourceData1, rawClient)
		patches.Reset()
		assert.NotNil(t, err)
	})
	...
	t.Run("ReadListTrafficMirrorFiltersNotFound", func(t *testing.T) {
		...
		err := resourceAliCloudVpcTrafficMirrorFilterIngressRuleRead(d, rawClient)
