...
func TestUnitAliCloudECSDeploymentSet(t *testing.T) {
	...
	ReadMockResponse := map[string]interface{}{
		"DeploymentSets": map[string]interface{}{
			"DeploymentSet": []interface{}{
	...
	responseMock := map[string]func(errorCode string) (map[string]interface{}, error){
		...
		"CreateNormal": func(errorCode string) (map[string]interface{}, error) {
			result := ReadMockResponse
			result["DeploymentSetId"] = "MockDeploymentSetId"
			return result, nil
		},
		...
		"ReadDescribeEcsDeploymentSetNotFound": func(errorCode string) (map[string]interface{}, error) {
	...
	t.Run("UpdateDeploymentSetAttributeAbnormal", func(t *testing.T) {
		diff := terraform.NewInstanceDiff()
		for _, key := range []string{"deployment_set_name", "description"} {
			switch p["alicloud_ecs_deployment_set"].Schema[key].Type {
		...
		resourceData1, _ := schema.InternalMap(p["alicloud_ecs_deployment_set"].Schema).Data(nil, diff)
	...
	t.Run("UpdateDeploymentSetAttributeNormal", func(t *testing.T) {
		diff := terraform.NewInstanceDiff()
		for _, key := range []string{"deployment_set_name", "description"} {
			switch p["alicloud_ecs_deployment_set"].Schema[key].Type {
			case schema.TypeString:
	...
	//Read
	t.Run("ReadDescribeEcsDeploymentSetNotFound", func(t *testing.T) {
		patcheDorequest := gomonkey.ApplyMethod(reflect.TypeOf(&client.Client{}), "DoRequest", func(_ *client.Client, _ *string, _ *string, _ *string, _ *string, _ *string, _ map[string]interface{}, _ map[string]interface{}, _ *util.RuntimeOptions) (map[string]interface{}, error) {
			NotFoundFlag := true
			noRetryFlag := false
			if NotFoundFlag {
				return responseMock["ReadDescribeEcsDeploymentSetNotFound"]("")
			} else if noRetryFlag {
	...
	t.Run("ReadDescribeEcsDeploymentSetAbnormal", func(t *testing.T) {
		patcheDorequest := gomonkey.ApplyMethod(reflect.TypeOf(&client.Client{}), "DoRequest", func(_ *client.Client, _ *string, _ *string, _ *string, _ *string, _ *string, _ map[string]interface{}, _ map[string]interface{}, _ *util.RuntimeOptions) (map[string]interface{}, error) {
			retryFlag := false
			noRetryFlag := true
			if retryFlag {
