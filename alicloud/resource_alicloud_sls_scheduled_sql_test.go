		...
		Steps: []resource.TestStep{
			{
				Config: testAccConfig(map[string]interface{}{
					...
					"project":            "${alicloud_log_project.defaultKIe4KV.id}",
				}),
...
resource "alicloud_log_project" "defaultKIe4KV" {
  description = "terraform-scheduledsql-test-520"
  name        = "terraform-scheduledsql-test-707"
}
...
resource "alicloud_log_project" "defaultKIe4KV" {
  description = "terraform-scheduledsql-test-483"
  name        = "terraform-scheduledsql-test-910"
}
...
resource "alicloud_log_project" "defaultKIe4KV" {
  description = "terraform-scheduledsql-test-855"
  name        = "terraform-scheduledsql-test-959"
}
