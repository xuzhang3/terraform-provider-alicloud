...
func Provider() *schema.Provider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"alicloud_cloud_monitor_service_metric_alarm_rules":   dataSourceAliCloudCloudMonitorServiceMetricAlarmRules(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"alicloud_esa_url_observation":                                  resourceAliCloudEsaUrlObservation(),
			...
			"alicloud_ess_instance_refresh":                                 resourceAlicloudEssInstanceRefresh(),
			...
			"alicloud_cms_site_monitor":                                      resourceAliCloudCloudMonitorServiceSiteMonitor(),
			...
			"alicloud_kvstore_account":                                       resourceAliCloudRedisAccount(),
			...
			"alicloud_vpc_vbr_ha":                                            resourceAliCloudExpressConnectVbrHa(),
