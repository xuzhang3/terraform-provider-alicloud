...
📚 Need more examples? [VIEW MORE EXAMPLES](https://api.aliyun.com/terraform?activeTab=sample&source=Sample&sourcePath=OfficialSample:alicloud_ros_stack_group&spm=docs.r.ros_stack_group.example&intl_lang=EN_US)
