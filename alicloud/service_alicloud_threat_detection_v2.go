...
// DescribeThreatDetectionCheckItemConfig <<< Encapsulated get interface for ThreatDetection CheckItemConfig.

func (s *ThreatDetectionServiceV2) DescribeThreatDetectionCheckItemConfig(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	if err != nil {
		return object, WrapErrorf(err, FailedGetAttributeMsg, id, "$.CheckItems[*]", response)
	}

	if len(v.([]interface{})) == 0 {
		return object, WrapErrorf(NotFoundErr("CheckItemConfig", id), NotFoundMsg, response)
	}
...
// DescribeThreatDetectionCheckItemConfig >>> Encapsulated.
// DescribeThreatDetectionCheckStructure <<< Encapsulated get interface for ThreatDetection CheckStructure.

func (s *ThreatDetectionServiceV2) DescribeThreatDetectionCheckStructure(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	v, err := jsonpath.Get("$.CheckStructureResponse[*]", response)
	if err != nil {
		return object, WrapErrorf(err, FailedGetAttributeMsg, id, "$.CheckStructureResponse[*]", response)
	}

	if len(v.([]interface{})) == 0 {
		return object, WrapErrorf(NotFoundErr("CheckStructure", id), NotFoundMsg, response)
	}

	currentStatus := v.([]interface{})[0].(map[string]interface{})["StandardsChild"]
...
// DescribeThreatDetectionCheckStructure >>> Encapsulated.
// DescribeThreatDetectionCheckConfig <<< Encapsulated get interface for ThreatDetection CheckConfig.

func (s *ThreatDetectionServiceV2) DescribeThreatDetectionCheckConfig(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
