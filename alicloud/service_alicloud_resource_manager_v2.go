...
func (s *ResourceManagerServiceV2) DescribeResourceManagerResourceDirectory(id string) (object map[string]interface{}, err error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ResourceDirectoryNotInUse"}) {
			return object, WrapErrorf(NotFoundErr("ResourceDirectory", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
// DescribeResourceManagerResourceDirectory >>> Encapsulated.

// DescribeResourceManagerFolder <<< Encapsulated get interface for ResourceManager Folder.

func (s *ResourceManagerServiceV2) DescribeResourceManagerFolder(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"EntityNotExists.Folder", "EntityNotExists.ResourceDirectory"}) {
			return object, WrapErrorf(NotFoundErr("Folder", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *ResourceManagerServiceV2) DescribeFolderListTagResources(id string) (object interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
// DescribeResourceManagerSharedTarget <<< Encapsulated get interface for ResourceManager SharedTarget.

func (s *ResourceManagerServiceV2) DescribeResourceManagerSharedTarget(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	for {
		...
		if v, ok := resp.([]interface{}); !ok || len(v) < 1 {
			return object, WrapErrorf(NotFoundErr("SharedTarget", id), NotFoundWithResponse, response)
		}
...
// DescribeResourceManagerControlPolicyAttachment <<< Encapsulated get interface for ResourceManager ControlPolicyAttachment.

func (s *ResourceManagerServiceV2) DescribeResourceManagerControlPolicyAttachment(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
...
// DescribeResourceManagerControlPolicyAttachment >>> Encapsulated.
// DescribeResourceManagerMessageContact <<< Encapsulated get interface for ResourceManager MessageContact.

func (s *ResourceManagerServiceV2) DescribeResourceManagerMessageContact(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	addDebug(action, response, request)
	if err != nil {
		if IsExpectedErrors(err, []string{"EntityNotExists.Contact"}) {
			return object, WrapErrorf(NotFoundErr("MessageContact", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *ResourceManagerServiceV2) DescribeResourceManagerControlPolicy(id string) (object map[string]interface{}, err error) {
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"EntityNotExists.ControlPolicy"}) {
			return object, WrapErrorf(NotFoundErr("ControlPolicy", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
func (s *ResourceManagerServiceV2) DescribeControlPolicyListTagResources(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	request["ResourceType"] = "ControlPolicy"
	action := "ListTagResources"
...
// DescribeResourceManagerControlPolicy >>> Encapsulated.
// DescribeResourceManagerMultiAccountDeliveryChannel <<< Encapsulated get interface for ResourceManager MultiAccountDeliveryChannel.

func (s *ResourceManagerServiceV2) DescribeResourceManagerMultiAccountDeliveryChannel(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	addDebug(action, response, request)
	if err != nil {
		if IsExpectedErrors(err, []string{"NotExists.DeliveryChannelId"}) {
			return object, WrapErrorf(NotFoundErr("MultiAccountDeliveryChannel", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
// DescribeResourceManagerMultiAccountDeliveryChannel >>> Encapsulated.
...
func (s *ResourceManagerServiceV2) DescribeResourceManagerResourceShare(id string) (object map[string]interface{}, err error) {
	...
	if len(v.([]interface{})) == 0 {
		return object, WrapErrorf(NotFoundErr("ResourceShare", id), NotFoundMsg, response)
	}
...
func (s *ResourceManagerServiceV2) SetResourceTagsForResourceSharing(d *schema.ResourceData, resourceType string) error {
	if d.HasChange("tags") {
		var action string
		var err error
		client := s.client
...
// DescribeResourceManagerDeliveryChannel <<< Encapsulated get interface for ResourceManager DeliveryChannel.

func (s *ResourceManagerServiceV2) DescribeResourceManagerDeliveryChannel(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]interface{}
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"NotExists.DeliveryChannelId"}) {
			return object, WrapErrorf(NotFoundErr("DeliveryChannel", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
