		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						...
						"fc_service_config.0.content_type_category": "DEFAULT",
						"fc_service_config.0.content_type_value":    "application/x-www-form-urlencoded; charset=UTF-8",
					}),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						...
						"fc_service_config.0.content_type_category": "CUSTOM",
						"fc_service_config.0.content_type_value":    "application/json",
					}),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						...
						"fc_service_config.0.timeout":               "20",
						"fc_service_config.0.arn_role":              "cloudapi-openapi",
						"fc_service_config.0.content_type_category": "CLIENT",
						"fc_service_config.0.content_type_value":    "",
					}),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheck(map[string]string{
						...
						"fc_service_config.0.function_type":         "HttpTrigger",
						"fc_service_config.0.function_base_url":     "http://apigateway-backend.alicloudapi.com/fcapp.run/",
						"fc_service_config.0.path":                  "/test/path/update",
						"fc_service_config.0.method":                "GET",
						"fc_service_config.0.only_business_path":    "false",
						"fc_service_config.0.region":                defaultRegionToTest,
						"fc_service_config.0.timeout":               "20",
