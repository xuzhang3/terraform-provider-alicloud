...
func TestUnitAliCloudEcsSessionManagerStatus(t *testing.T) {
	...
	ReadMockResponse := map[string]interface{}{
		"SessionManagerStatusName": "session_manager_status_name",
		"StatusValue":              "Enabled",
	}
	...
	responseMock := map[string]func(errorCode string) (map[string]interface{}, error){
		...
		"NotFoundError": func(errorCode string) (map[string]interface{}, error) {
			return nil, GetNotFoundErrorFromString(GetNotFoundMessage("alicloud_ecs_session_manager_status", "MockStatusKey"))
		},
		...
		"CreateNormal": func(errorCode string) (map[string]interface{}, error) {
			...
			result["statusKey"] = "MockStatusKey"
			return result, nil
		},
	...
	t.Run("UpdateModifyUserBusinessBehaviorAbnormal", func(t *testing.T) {
		diff := terraform.NewInstanceDiff()
		for _, key := range []string{"status"} {
			switch p["alicloud_ecs_session_manager_status"].Schema[key].Type {
		...
		resourceData1, _ := schema.InternalMap(p["alicloud_ecs_session_manager_status"].Schema).Data(nil, diff)
	...
	t.Run("UpdateModifyUserBusinessBehaviorNormal", func(t *testing.T) {
		diff := terraform.NewInstanceDiff()
		for _, key := range []string{"status"} {
			switch p["alicloud_ecs_session_manager_status"].Schema[key].Type {
			case schema.TypeString:
	...
	//Read
	t.Run("ReadDescribeEcsSessionManagerStatusNotFound", func(t *testing.T) {
	...
	t.Run("ReadDescribeEcsSessionManagerStatusAbnormal", func(t *testing.T) {
