...
// DescribeSlsLogtailConfig <<< Encapsulated get interface for Sls LogtailConfig.

func (s *SlsServiceV2) DescribeSlsLogtailConfig(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]*string
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ConfigNotExist"}) {
			return object, WrapErrorf(NotFoundErr("LogtailConfig", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
// DescribeSlsLogtailConfig >>> Encapsulated.

// DescribeSlsMachineGroup <<< Encapsulated get interface for Sls MachineGroup.

func (s *SlsServiceV2) DescribeSlsMachineGroup(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]*string
	...
	addDebug(action, response, request)
	if err != nil {
		if IsExpectedErrors(err, []string{"MachineGroupNotExist"}) {
			return object, WrapErrorf(NotFoundErr("MachineGroup", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
// DescribeSlsMachineGroup >>> Encapsulated.

// DescribeSlsIndex <<< Encapsulated get interface for Sls Index.

func (s *SlsServiceV2) DescribeSlsIndex(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]*string
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"IndexConfigNotExist"}) {
			return object, WrapErrorf(NotFoundErr("Index", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
// DescribeSlsLogtailPipelineConfig <<< Encapsulated get interface for Sls LogtailPipelineConfig.

func (s *SlsServiceV2) DescribeSlsLogtailPipelineConfig(id string) (object map[string]interface{}, err error) {
	client := s.client
	var request map[string]interface{}
	var response map[string]interface{}
	var query map[string]*string
	...
	if err != nil {
		if IsExpectedErrors(err, []string{"ConfigNotExist"}) {
			return object, WrapErrorf(NotFoundErr("LogtailPipelineConfig", id), NotFoundMsg, response)
		}
		return object, WrapErrorf(err, DefaultErrorMsg, id, action, AlibabaCloudSdkGoERROR)
	}
...
// DescribeSlsLogtailPipelineConfig >>> Encapsulated.
